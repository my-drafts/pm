...
class Gameable{
	constructor(is, game, options){
		if(is && (typeof is=='string' || is instanceof String)){
			...
			throw '[Gameable.constructor]: Wrong is';
		}
		...
		if(game && game instanceof Game){
			...
			throw '[Gameable.constructor]: Wrong game in ' + this._is;
		}

		if(options && options instanceof Object){
		}
		else{
			throw '[Gameable.constructor]: Wrong options in ' + this._is;
		}
		...
		if(typeof options.draw=='function'){
			...
			throw '[Gameable.constructor]: Wrong draw in ' + this._is;
		}
	}
